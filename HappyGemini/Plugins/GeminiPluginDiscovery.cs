...
public sealed class GeminiPluginDiscovery
{
    ...
    /// </summary>
    public IReadOnlyList<GeminiPluginDescriptor> Discover(
        string pluginDirectory)
    {
        ...
        string pluginRoot =
            ResolvePluginRoot(pluginDirectory);
    ...
    private static GeminiPluginManifest ReadManifest(
        string manifestPath)
    {
        try
        {
            ...
            return JsonSerializer
                .Deserialize<GeminiPluginManifest>(
                    json,
                    JsonOptions)
    ...
    private static void EnsureUniquePluginIds(
        IEnumerable<GeminiPluginDescriptor> plugins)
    {
        ...
        foreach (GeminiPluginDescriptor plugin in plugins)
        {
            ...
            {
                throw new InvalidDataException(
                    $"Duplicate Gemini plugin id '{plugin.Id}'.");
            }
        }
    }
}